...
the original source code of def cal_sample_weight, cosine_distance_torch, to_sparse, cal_adj_mat_parameter, graph_from_dist_tensor, gen_adj_mat_tensor, gen_val_adj_mat_tensor is released under the MIT License
